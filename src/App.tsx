...
import AdminElectionResult from "./pages/Admin/ElectionResult";
...
import ElectionResult from "./pages/Client/ElectionResult";
...
function App() {
    ...
    return (
        <AuthProvider>
            <div className="h-screen flex justify-center font-display font-medium">
                    ...
                    <BrowserRouter>
                        <Routes>
                            ...
                            <Route path="/admin/election-result/:id"
                                   element={<RequireAuth><AdminElectionResult/></RequireAuth>}/>
                            ...
                            <Route path="/election-result/:id" element={<RequireAuth><ElectionResult/></RequireAuth>}/>
